...
- `del_student()` - удаление студента по ID со сдвигом элементов массива
...
- **Динамическое масштабирование** - массив увеличивается и уменьшается автоматически
- **Умное управление памятью**:
  - Корректное использование `realloc` через временные указатели
  - Обработка edge case при удалении последнего элемента (освобождение всей памяти)
  - Предотвращение утечек памяти
- **Алгоритм удаления элемента**:
  - Поиск элемента по ID (не по индексу)
  - Сдвиг элементов влево через перезапись памяти
  - Автоматическое уменьшение массива
...
✅ **Алгоритмы работы с массивами** - вставка, удаление, поиск элементов
✅ **Управление памятью** - корректное увеличение/уменьшение динамических массивов
...
✅ **Обработка ошибок** - проверка всех критических операций и edge cases
